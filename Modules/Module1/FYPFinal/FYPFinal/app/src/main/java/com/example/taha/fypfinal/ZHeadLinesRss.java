...
public class ZHeadLinesRss  extends AsyncTask<Void,Void,Void>{
    ...
    String address1="https://www.geo.tv/rss/1/0";
    Context context;
    ArrayList<String> list=new ArrayList<>();
    ArrayList<Document> arr;
    URL url;
    ProgressDialog progressDialog;
    public  ZHeadLinesRss (Context context,RecyclerView recyclerView)
    {
