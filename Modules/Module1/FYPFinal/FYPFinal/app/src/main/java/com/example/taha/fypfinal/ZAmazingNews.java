...
public class ZAmazingNews  extends AsyncTask<Void,Void,Void>{
    String s1;
    ArrayList<FeedItem> feedItem;
    RecyclerView recyclerView;
    String address="http://www.sciencemag.org/rss/news_current.xml";
    String address1="https://www.geo.tv/rss/1/7";
    Context context;
    ArrayList<String> list=new ArrayList<>();
    ArrayList<Document> arr;
    URL url;
    ProgressDialog progressDialog;
    public ZAmazingNews(Context context,RecyclerView recyclerView)
    {
